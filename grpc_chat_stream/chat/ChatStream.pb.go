...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chat_ChatStream_proto_msgTypes[0]
...
func (*User) Descriptor() ([]byte, []int) {
	return file_chat_ChatStream_proto_rawDescGZIP(), []int{0}
}
...
func (x *Message) Reset() {
	*x = Message{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chat_ChatStream_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return file_chat_ChatStream_proto_rawDescGZIP(), []int{1}
}
...
func (x *Connect) Reset() {
	*x = Connect{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chat_ChatStream_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Connect) Descriptor() ([]byte, []int) {
	return file_chat_ChatStream_proto_rawDescGZIP(), []int{2}
}
...
func (x *Close) Reset() {
	*x = Close{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chat_ChatStream_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Close) Descriptor() ([]byte, []int) {
	return file_chat_ChatStream_proto_rawDescGZIP(), []int{3}
}

var File_chat_ChatStream_proto protoreflect.FileDescriptor

var file_chat_ChatStream_proto_rawDesc = []byte{
	0x0a, 0x15, 0x63, 0x68, 0x61, 0x74, 0x2f, 0x43, 0x68, 0x61, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61,
	0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x63, 0x68, 0x61, 0x74, 0x22, 0x39, 0x0a,
	...
	0x70, 0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x71, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73,
	...
	0x0a, 0x05, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x32, 0x6b, 0x0a, 0x09, 0x42, 0x72, 0x6f, 0x61, 0x64,
	0x43, 0x61, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x74,
...
var (
	file_chat_ChatStream_proto_rawDescOnce sync.Once
	file_chat_ChatStream_proto_rawDescData = file_chat_ChatStream_proto_rawDesc
)

func file_chat_ChatStream_proto_rawDescGZIP() []byte {
	file_chat_ChatStream_proto_rawDescOnce.Do(func() {
		file_chat_ChatStream_proto_rawDescData = protoimpl.X.CompressGZIP(file_chat_ChatStream_proto_rawDescData)
	})
	return file_chat_ChatStream_proto_rawDescData
}

var file_chat_ChatStream_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_chat_ChatStream_proto_goTypes = []interface{}{
	(*User)(nil),    // 0: chat.User
	(*Message)(nil), // 1: chat.Message
	(*Connect)(nil), // 2: chat.Connect
	(*Close)(nil),   // 3: chat.Close
}
var file_chat_ChatStream_proto_depIdxs = []int32{
...
func init() { file_chat_ChatStream_proto_init() }
func file_chat_ChatStream_proto_init() {
	if File_chat_ChatStream_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_chat_ChatStream_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_chat_ChatStream_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chat_ChatStream_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chat_ChatStream_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Close); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_chat_ChatStream_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_chat_ChatStream_proto_goTypes,
		DependencyIndexes: file_chat_ChatStream_proto_depIdxs,
		MessageInfos:      file_chat_ChatStream_proto_msgTypes,
	}.Build()
	File_chat_ChatStream_proto = out.File
	file_chat_ChatStream_proto_rawDesc = nil
	file_chat_ChatStream_proto_goTypes = nil
	file_chat_ChatStream_proto_depIdxs = nil
}
...
var _BroadCast_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "chat/ChatStream.proto",
}
